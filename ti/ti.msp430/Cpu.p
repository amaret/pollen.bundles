...
module Cpu implements CpuProtocol {
  ...
  public host uint32 getSubSystemClockFrequencyOnHost() {
    return smclkFreq
  }
   
  public uint32 getSubSystemClockFrequency() {
    return smclkFreq
  }

  public host uint32 getAuxillaryClockFrequencyOnHost() {
    return aclkFreq
  }

  public uint32 getAuxillaryClockFrequency() {
    return aclkFreq
  }
